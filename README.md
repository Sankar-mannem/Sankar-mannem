...
I enjoy working with data from raw format to final business recommendations — cleaning datasets, exploring trends, creating dashboards, tracking KPIs, and explaining insights in a simple way for decision-making.

My current focus is on building end-to-end analytics case studies:

**data → cleaning → analysis → dashboard → insights → recommendations** 🎯
